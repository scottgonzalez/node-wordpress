...
maps.file = createFieldMaps({
	...
	bits     : "bits",      // string binary data, shouldn't be base64-encoded
	overwrite: "overwrite", // bool, optional, overwrite an existing attachment of the same name. (Added in WordPress 2.2)
	postId   : "post_id",   // int, optional. Allows an attachment to be assigned to a post. (User must have permission to edit the assigned post)
});
